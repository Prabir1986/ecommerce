<?php 
session_start();
require_once("controllers/classmodel/class.user.php");
...
<body>
<!-- header -->
<?php include "layouts/topheadermenu.php";?>
<!-- //banner-top -->
<?php include "layouts/signInModal.php";?>
<?php include "layouts/signUpModal.php";?>
...
<!-- login -->
  <?php include "layouts/footerLogin.php";?>			
<!-- //login -->
...
<script type="text/javascript" src="js/controllers/loginsignup.js"></script>
</body>
</html>